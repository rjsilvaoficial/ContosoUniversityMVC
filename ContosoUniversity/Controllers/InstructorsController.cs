    ...
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? courseID)
        {
            ...
            if (id != null)
            {
                ...
                //Aqui é gerada uma lista com cada atb Course em CourseAssignments via select()
        ...
        //O método abaixo gera o insumo para renderização dos itens selecionáveis courses na View
